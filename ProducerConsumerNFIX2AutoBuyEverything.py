...
#############################################################################################################
##                !!!   WARNING: Strategy modified Will auto buy every paires !!!                          ##
##                                                                                                         ##
##                         TEST PRODUCER/CONSUMER STATEGY                                                  ##
##                                                                                                         ##
#############################################################################################################
...
class ProducerConsumerNFIX2AutoBuyEverything(IStrategy):
    INTERFACE_VERSION = 3
    ...
    def populate_indicators_from_producers(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        #           are going to throw errors (ex: custom_exit)
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        for buy_enable in self.buy_params:
            ...
            if self.buy_params[f'{buy_enable}']:
                ...
                if index == 1:
                    # Protections
                    item_buy_logic.append(dataframe['btc_pct_close_max_24_5m'] < 10.03)
                    item_buy_logic.append(dataframe['btc_pct_close_max_72_5m'] < 10.03)
